icemons = {}
icemons.mod = "redo-redo"
function icemons:register_mob(name, def)
...
icemons.spawning_mobs = {}
function icemons:register_spawn(name, nodes, max_light, min_light, chance, active_object_count, max_height, min_dist, max_dist, spawn_func)
	icemons.spawning_mobs[name] = true
	minetest.register_abm({
		...
		action = function(pos, node, _, active_object_count_wider)
			...
			if not icemons.spawning_mobs[name] then
				return
			end
